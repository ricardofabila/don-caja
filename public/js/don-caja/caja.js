...
var _user$project$Flags$Flags = F6(
	function (a, b, c, d, e, f) {
		return {successPageUrl: a, getUsersUrl: b, createNewUserUrl: c, addDepositUrl: d, addTransactionsUrl: e, csrf_token: f};
	});

var _user$project$Models_Page$Users = {ctor: 'Users'};
var _user$project$Models_Page$Deposits = {ctor: 'Deposits'};
var _user$project$Models_Page$Cart = {ctor: 'Cart'};

var _user$project$Models_Transaction$Transaction = F3(
	function (a, b, c) {
		return {userIdentifier: a, userName: b, amount: c};
	});

var _user$project$Models_User$User = F3(
	function (a, b, c) {
		return {identifier: a, name: b, balance: c};
	});
																...
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return function (u) {
																					return {users: a, loadingUsers: b, selectedUser: c, quantity: d, transactions: e, availableUsers: f, currentPage: g, creatingUser: h, newUserName: i, newUserBalance: j, selectedUserForDeposit: k, depositQuantity: l, allUsersVisible: m, addingDeposit: n, addingTransactions: o, successPageUrl: p, getUsersUrl: q, createNewUserUrl: r, addDepositUrl: s, addTransactionsUrl: t, csrf_token: u};
																				};
																			};
																		};
																	};
...
var _user$project$Msg$NewTransactionsDataReceived = function (a) {
	return {ctor: 'NewTransactionsDataReceived', _0: a};
};
var _user$project$Msg$RegisterTransactions = {ctor: 'RegisterTransactions'};
var _user$project$Msg$NewDepositDataReceived = function (a) {
	return {ctor: 'NewDepositDataReceived', _0: a};
};
var _user$project$Msg$RegisterDeposit = {ctor: 'RegisterDeposit'};
var _user$project$Msg$NewUserDataReceived = function (a) {
	return {ctor: 'NewUserDataReceived', _0: a};
};
var _user$project$Msg$CreateNewUser = {ctor: 'CreateNewUser'};
var _user$project$Msg$UsersDataReceived = function (a) {
	return {ctor: 'UsersDataReceived', _0: a};
};
var _user$project$Msg$LoadUsers = {ctor: 'LoadUsers'};
var _user$project$Msg$ViewAllUsers = {ctor: 'ViewAllUsers'};
var _user$project$Msg$SetDepositQuantity = function (a) {
	return {ctor: 'SetDepositQuantity', _0: a};
};
var _user$project$Msg$SelectUserForDeposit = function (a) {
	return {ctor: 'SelectUserForDeposit', _0: a};
};
var _user$project$Msg$SetNewUserName = function (a) {
	return {ctor: 'SetNewUserName', _0: a};
};
var _user$project$Msg$SetNewUserBalance = function (a) {
	return {ctor: 'SetNewUserBalance', _0: a};
};
var _user$project$Msg$ChangePage = function (a) {
	return {ctor: 'ChangePage', _0: a};
};
var _user$project$Msg$CalculateAvailableUsers = {ctor: 'CalculateAvailableUsers'};
var _user$project$Msg$RemoveTransaction = function (a) {
	return {ctor: 'RemoveTransaction', _0: a};
};
var _user$project$Msg$AddTransaction = {ctor: 'AddTransaction'};
var _user$project$Msg$SetQuantity = function (a) {
	return {ctor: 'SetQuantity', _0: a};
};
var _user$project$Msg$SelectUser = function (a) {
	return {ctor: 'SelectUser', _0: a};
};

var _user$project$Renderers_Transaction$create = F3(
	function (availableUsers, transactions, quantity) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('pure-form'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('new-transaction-register'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('new-transaction-register-user'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$select,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Msg$SelectUser),
												_1: {ctor: '[]'}
											}
										}
									},
										...
										function (user) {
											return A2(
												_elm_lang$html$Html$option,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(
														_elm_lang$core$Basics$toString(user.identifier)),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_elm_community$string_extra$String_Extra$toTitleCase(user.name)),
													_1: {ctor: '[]'}
												});
										},
										availableUsers)),
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('new-transaction-register-amount'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A3(
										...
										A5(
											_abadi199$elm_input_extra$Input_Number$Options,
											_elm_lang$core$Maybe$Just(4),
											_elm_lang$core$Maybe$Just(200),
											_elm_lang$core$Maybe$Just(0),
											_user$project$Msg$SetQuantity,
											_elm_lang$core$Maybe$Nothing),
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('form-control'),
										...
										_elm_lang$core$Maybe$Just(quantity)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('new-transaction-register-button'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$AddTransaction),
											_1: {ctor: '[]'}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Registrar Compra'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Renderers_Transaction$display = F2(
	function (index, transaction) {
		var extraClass = function () {
			var _p0 = A2(_elm_lang$core$Basics_ops['%'], index, 2);
			if (_p0 === 0) {
				return 'transaction__yellow';
			} else {
				return '';
			}
		}();
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'transaction ', extraClass)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('transaction--cross'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Msg$RemoveTransaction(transaction.userIdentifier)),
							_1: {ctor: '[]'}
						}
					},
					{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('transaction--name'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_community$string_extra$String_Extra$toTitleCase(transaction.userName)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('transaction--amount'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(
										...
										A2(
											...
											2,
											_elm_lang$core$Basics$toFloat(transaction.amount)))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Renderers_User$display = F2(
	function (index, user) {
		var extraClass = function () {
			var _p0 = A2(_elm_lang$core$Basics_ops['%'], index, 2);
			if (_p0 === 0) {
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'account ', extraClass)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: (_elm_lang$core$Native_Utils.cmp(user.balance, 0) < 1) ? A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('account--amount account--amount-red'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(
									...
									A2(
										_myrho$elm_round$Round$round,
										2,
										_elm_lang$core$Basics$toFloat(user.balance)))),
							_1: {ctor: '[]'}
						}) : A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('account--amount'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Pages_Cart$display = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('col-xs-12 col-sm-12 col-md-7'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						},
						{
								...
								},
								{
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												_elm_lang$html$Html$span,
												{
													...
													_0: _elm_lang$html$Html_Attributes$style(
														{
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'font-size', _1: '25pt'},
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												},
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text('Transacciones'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('card--header-subtitle'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Aquí registrar nuevas transacciones por compras de comida.'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
									A2(_elm_lang$core$List$indexedMap, _user$project$Renderers_Transaction$display, model.transactions)),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('transactions--total'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: A2(
														...
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('transactions--total-text'),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('En caja: '),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		...
																		_0: (_elm_lang$core$Native_Utils.cmp(
																			...
																			_elm_lang$core$List$sum(
																				A2(
																					...
																					model.transactions))) > 0) ? A2(
																			_elm_lang$html$Html$div,
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('btn btn__yellow'),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Falta lana, compa 😱'),
																				_1: {ctor: '[]'}
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('btn btn__green'),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$RegisterTransactions),
																					_1: {ctor: '[]'}
																				}
																			},
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Terminar'),
																				_1: {ctor: '[]'}
																			}) : A2(
																			_elm_lang$html$Html$div,
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('btn btn__grey'),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
											...
											_1: {
												...
												_0: _elm_lang$core$Native_Utils.eq(
													_elm_lang$core$List$length(model.availableUsers),
													0) ? A2(
													_elm_lang$html$Html$div,
													{ctor: '[]'},
													{ctor: '[]'}) : A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('new-transaction'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('new-transaction--title'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: A2(
																	_elm_lang$html$Html$span,
																	{
																		...
																		_0: _elm_lang$html$Html_Attributes$style(
																			{
																				ctor: '::',
																				_0: {ctor: '_Tuple2', _0: 'font-size', _1: '20pt'},
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	},
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Registrar transacción de compra'),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {
															...
															_1: {
																ctor: '::',
																_0: A3(_user$project$Renderers_Transaction$create, model.availableUsers, model.transactions, model.quantity),
																_1: {ctor: '[]'}
															}
														}
													}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-xs-12  col-sm-12 col-md-5'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							},
							{
									...
									},
									{
										...
										_0: A2(
											...
											},
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text('Estado de cuentas'),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Aquí puedes ver a quien ajusticiarte 😈 y quien es 😇'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
								...
								_1: {
									ctor: '::',
									_0: model.allUsersVisible ? A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										A2(_elm_lang$core$List$indexedMap, _user$project$Renderers_User$display, model.users)) : A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										A2(
											_elm_lang$core$List$indexedMap,
											_user$project$Renderers_User$display,
											A2(_elm_lang$core$List$take, 8, model.users))),
									_1: {
										ctor: '::',
										_0: ((!model.allUsersVisible) && (_elm_lang$core$Native_Utils.cmp(
											...
											},
											{
												...
												_0: A2(
													_elm_lang$html$Html$p,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$ViewAllUsers),
															_1: {ctor: '[]'}
														}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('ver todos'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}) : A2(
...
var _user$project$Pages_Deposits$display = F2(
	function (users, depositQuantity) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-xs-12 col-md-offset-2 col-md-8'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
							...
							},
							{
									...
									},
									{
										...
										_0: A2(
											...
											},
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text('Registar abono'),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Aquí registrar un abono de un usuario a la caja.'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										A2(_elm_lang$core$List$indexedMap, _user$project$Renderers_User$display, users)),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
													...
													},
													{
														...
														_0: A2(
															...
															},
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Registrar deposito'),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {
																						...
																						_0: A2(
																							_elm_lang$html$Html$select,
																							{
																								...
																								_1: {
																									...
																									_1: {
																										ctor: '::',
																										_0: _elm_lang$html$Html_Events$onInput(_user$project$Msg$SelectUserForDeposit),
																										_1: {ctor: '[]'}
																									}
																								}
																							},
																						...
																						},
																						{
																							...
																							_0: A3(
																								...
																								A5(
																									...
																									_elm_lang$core$Maybe$Just(0),
																									_user$project$Msg$SetDepositQuantity,
																									_elm_lang$core$Maybe$Nothing),
																								{
																									ctor: '::',
																									_0: _elm_lang$html$Html_Attributes$class('form-control'),
																								...
																								_elm_lang$core$Maybe$Just(depositQuantity)),
																							_1: {ctor: '[]'}
																						}),
																					_1: {
																						ctor: '::',
																						_0: A2(
																							_elm_lang$html$Html$div,
																							{
																								...
																								_1: {
																									ctor: '::',
																									_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$RegisterDeposit),
																									_1: {ctor: '[]'}
																								}
																							},
																							{
...
var _user$project$Pages_Users$display = F4(
	function (users, newUserName, newUserBalance, creatingUser) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
									...
									},
									{
										...
										_0: A2(
											...
											},
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text(' Nuevo usuario'),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Aquí añadir un nuevo usuario al sistema.'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Registar un nuevo usuario'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
																				...
																				_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$placeholder('usuario'),
																								_1: {
																									ctor: '::',
																									...
																									_1: {
																										...
																										_1: {
																											ctor: '::',
																											_0: _elm_lang$html$Html_Attributes$value(newUserName),
																											_1: {
																												ctor: '::',
																												_0: _elm_lang$html$Html_Events$onInput(_user$project$Msg$SetNewUserName),
																												_1: {ctor: '[]'}
																											}
																										}
																									}
																						...
																						},
																						{
																							...
																							_0: A3(
																								...
																								A5(
																									_abadi199$elm_input_extra$Input_Number$Options,
																									_elm_lang$core$Maybe$Just(4),
																									_elm_lang$core$Maybe$Just(150),
																									_elm_lang$core$Maybe$Just(0),
																									_user$project$Msg$SetNewUserBalance,
																									_elm_lang$core$Maybe$Nothing),
																								{
																									ctor: '::',
																									_0: _elm_lang$html$Html_Attributes$class('form-control'),
																								...
																								_elm_lang$core$Maybe$Just(newUserBalance)),
																							_1: {ctor: '[]'}
																						}),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$core$Native_Utils.eq(creatingUser, 'loading') ? A2(
																							_elm_lang$html$Html$div,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$class('new-transaction-register-button new-transaction-register-button-yellow'),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text('Creando'),
																								_1: {ctor: '[]'}
																							}) : (_elm_lang$core$Native_Utils.eq(creatingUser, '') ? A2(
																							_elm_lang$html$Html$div,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$class('new-transaction-register-button'),
																								_1: {
																									ctor: '::',
																									_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$CreateNewUser),
																									_1: {ctor: '[]'}
																								}
																							},
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text('Crear Usuario'),
																								_1: {ctor: '[]'}
																							}) : A2(
																							_elm_lang$html$Html$div,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$class('new-transaction-register-button new-transaction-register-button-reds'),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text('Error Inesperado'),
																								_1: {ctor: '[]'}
																							})),
																						_1: {ctor: '[]'}
																					}
...
var _user$project$Renderers_Footer$display = function (currentPage) {
	var activeStyle = _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'opacity', _1: '1'},
			_1: {ctor: '[]'}
		});
	var cartActiveClass = function () {
		var _p0 = currentPage;
		if (_p0.ctor === 'Cart') {
			return activeStyle;
		} else {
	...
	var depositsActiveClass = function () {
		var _p1 = currentPage;
		if (_p1.ctor === 'Deposits') {
			return activeStyle;
		} else {
			return _elm_lang$html$Html_Attributes$style(
				{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Msg$ChangePage(_user$project$Models_Page$Users)),
							_1: {ctor: '[]'}
						}
					}
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$span,
						{
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'font-size', _1: '45pt'},
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('Usuarios'),
							_1: {ctor: '[]'}
						}
					}
				}),
					...
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Msg$ChangePage(_user$project$Models_Page$Cart)),
								_1: {ctor: '[]'}
							}
						}
					},
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Msg$ChangePage(_user$project$Models_Page$Deposits)),
									_1: {ctor: '[]'}
								}
							}
						},
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('Abonos'),
									_1: {ctor: '[]'}
								}
							}
						}),
...
var _user$project$Rest_AddDeposit$transactionEncoder = function (transaction) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'user_id',
				_1: _elm_lang$core$Json_Encode$int(transaction.userIdentifier)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'name',
					_1: _elm_lang$core$Json_Encode$string(transaction.userName)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'amount',
						_1: _elm_lang$core$Json_Encode$int(transaction.amount)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$Rest_AddDeposit$transactionDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'user_id',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models_Transaction$Transaction))));
var _user$project$Rest_AddDeposit$addDepositRequest = F3(
	function (transaction, addDepositUrl, csrf_token) {
		return _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
				...
				body: _elm_lang$http$Http$jsonBody(
					_user$project$Rest_AddDeposit$transactionEncoder(transaction)),
				expect: _elm_lang$http$Http$expectJson(_user$project$Rest_AddDeposit$transactionDecoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$Rest_AddDeposit$addDepositCommand = F3(
	function (transaction, addDepositUrl, csrf_token) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Msg$NewDepositDataReceived,
			A3(_user$project$Rest_AddDeposit$addDepositRequest, transaction, addDepositUrl, csrf_token));
	});

var _user$project$Rest_CreateErrorMessage$createErrorMessage = function (httpError) {
	var _p0 = httpError;
	switch (_p0.ctor) {
		case 'BadUrl':
			return _p0._0;
...
var _user$project$Rest_CreateUser$userEncoder = function (user) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'balance',
					_1: _elm_lang$core$Json_Encode$int(user.balance)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Rest_CreateUser$usersDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'balance',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models_User$User))));
var _user$project$Rest_CreateUser$createUserRequest = F3(
	function (user, createNewUserUrl, csrf_token) {
		return _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
				...
				body: _elm_lang$http$Http$jsonBody(
					_user$project$Rest_CreateUser$userEncoder(user)),
				expect: _elm_lang$http$Http$expectJson(_user$project$Rest_CreateUser$usersDecoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$Rest_CreateUser$createUserCommand = F3(
	function (user, createNewUserUrl, csrf_token) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Msg$NewUserDataReceived,
			A3(_user$project$Rest_CreateUser$createUserRequest, user, createNewUserUrl, csrf_token));
	});

var _user$project$Rest_RegisterTransactions$transactionEncoder = function (transaction) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Rest_RegisterTransactions$transactionsEncoder = function (transactions) {
	var encodedTransactions = A2(_elm_lang$core$List$map, _user$project$Rest_RegisterTransactions$transactionEncoder, transactions);
	return _elm_lang$core$Json_Encode$array(
		_elm_lang$core$Array$fromList(encodedTransactions));
};
var _user$project$Rest_RegisterTransactions$transactionsDecoder = _elm_lang$core$Json_Decode$list(
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'amount',
		_elm_lang$core$Json_Decode$int,
		A3(
			...
			A3(
				...
				_elm_lang$core$Json_Decode$int,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models_Transaction$Transaction)))));
var _user$project$Rest_RegisterTransactions$registerTransactionsRequest = F3(
	function (transactions, addTransactionsUrl, csrf_token) {
		return _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
				...
				body: _elm_lang$http$Http$jsonBody(
					_user$project$Rest_RegisterTransactions$transactionsEncoder(transactions)),
				expect: _elm_lang$http$Http$expectJson(_user$project$Rest_RegisterTransactions$transactionsDecoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$Rest_RegisterTransactions$registerTransactionsCommand = F3(
	function (transactions, addTransactionsUrl, csrf_token) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Msg$NewTransactionsDataReceived,
			A3(_user$project$Rest_RegisterTransactions$registerTransactionsRequest, transactions, addTransactionsUrl, csrf_token));
	});

var _user$project$Rest_UsersLoader$usersDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'balance',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		A3(
			...
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models_User$User))));
var _user$project$Rest_UsersLoader$getUsersCommand = function (getUsersUrl) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msg$UsersDataReceived,
		A2(
			_elm_lang$http$Http$get,
			getUsersUrl,
			_elm_lang$core$Json_Decode$list(_user$project$Rest_UsersLoader$usersDecoder)));
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('container center-xs'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-xs'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$src('public/img/logo.png'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$style(
																{
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'max-width', _1: '211px'},
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$alt('Don Caja'),
																_1: {ctor: '[]'}
															}
														}
													},
			...
			_1: {
					...
					switch (_p0.ctor) {
						case 'Cart':
							return A2(
								...
								{
									ctor: '::',
									_0: _user$project$Pages_Cart$display(model),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$br,
						...
						case 'Deposits':
							return A2(
								...
								{
									ctor: '::',
									_0: A2(_user$project$Pages_Deposits$display, model.users, model.depositQuantity),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$br,
						...
						default:
							return A2(
								...
								{
									ctor: '::',
									_0: A4(_user$project$Pages_Users$display, model.users, model.newUserName, model.newUserBalance, model.creatingUser),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$br,
				...
				_1: {
					ctor: '::',
					_0: _user$project$Renderers_Footer$display(model.currentPage),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Main$msgToCmd = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$identity,
		...
		switch (_p1.ctor) {
			case 'LoadUsers':
				return {
					...
					_1: _user$project$Rest_UsersLoader$getUsersCommand(model.getUsersUrl)
				};
			case 'UsersDataReceived':
				if (_p1._0.ctor === 'Ok') {
					var _p4 = _p1._0._0;
					var _p2 = _elm_lang$core$List$head(_p4);
					if (_p2.ctor === 'Nothing') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{users: _p4, availableUsers: _p4, loadingUsers: '', selectedUser: _p3.identifier, selectedUserForDeposit: _p3.identifier}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								loadingUsers: _user$project$Rest_CreateErrorMessage$createErrorMessage(_p1._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'CreateNewUser':
				return {
					...
					_1: A3(
						_user$project$Rest_CreateUser$createUserCommand,
						A3(_user$project$Models_User$User, 0, model.newUserName, model.newUserBalance),
						model.createNewUserUrl,
						model.csrf_token)
				};
			case 'NewUserDataReceived':
				if (_p1._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{creatingUser: '', newUserBalance: 0, newUserName: '', currentPage: _user$project$Models_Page$Cart}),
						_1: _user$project$Main$msgToCmd(_user$project$Msg$LoadUsers)
					};
				} else {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								creatingUser: _user$project$Rest_CreateErrorMessage$createErrorMessage(_p1._0._0),
								newUserBalance: 0,
								newUserName: ''
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'NewDepositDataReceived':
				if (_p1._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{addingDeposit: '', selectedUserForDeposit: 0, depositQuantity: 0, currentPage: _user$project$Models_Page$Users}),
						_1: _user$project$Main$msgToCmd(_user$project$Msg$LoadUsers)
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								addingDeposit: _user$project$Rest_CreateErrorMessage$createErrorMessage(_p1._0._0),
								selectedUserForDeposit: 0,
								depositQuantity: 0
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'NewTransactionsDataReceived':
				if (_p1._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								addingTransactions: '',
								transactions: {ctor: '[]'},
								currentPage: _user$project$Models_Page$Cart
							}),
						_1: _user$project$Main$msgToCmd(_user$project$Msg$LoadUsers)
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								addingTransactions: _user$project$Rest_CreateErrorMessage$createErrorMessage(_p1._0._0),
								transactions: {ctor: '[]'}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'AddTransaction':
				var users = A2(
					_elm_lang$core$List$filter,
					function (user) {
						return _elm_lang$core$Native_Utils.eq(user.identifier, model.selectedUser);
					},
					model.users);
				var _p7 = _elm_lang$core$List$head(users);
				if (_p7.ctor === 'Nothing') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$msgToCmd(_user$project$Msg$CalculateAvailableUsers)
					};
				} else {
					var _p8 = _p7._0;
					return ((!_elm_lang$core$Native_Utils.eq(model.selectedUser, 0)) && ((!_elm_lang$core$Native_Utils.eq(model.quantity, 0)) && (!_elm_lang$core$Native_Utils.eq(_p8.name, '')))) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								transactions: {
									ctor: '::',
									_0: A3(_user$project$Models_Transaction$Transaction, model.selectedUser, _p8.name, -1 * model.quantity),
									_1: model.transactions
								}
							}),
						_1: _user$project$Main$msgToCmd(_user$project$Msg$CalculateAvailableUsers)
					} : {
			...
			case 'RemoveTransaction':
				var remainingTransactions = A2(
					_elm_lang$core$List$filter,
					function (t) {
						return !_elm_lang$core$Native_Utils.eq(t.userIdentifier, _p1._0);
					},
					model.transactions);
				return {
					ctor: '_Tuple2',
			...
			case 'CalculateAvailableUsers':
				var userIdsInTransactions = A2(
					_elm_lang$core$List$map,
					function (transaction) {
						return transaction.userIdentifier;
					},
					model.transactions);
				var availableUsers = A2(
					_elm_lang$core$List$filter,
					function (user) {
						return !A2(_elm_lang$core$List$member, user.identifier, userIdsInTransactions);
					},
					model.users);
				var _p9 = _elm_lang$core$List$head(availableUsers);
				if (_p9.ctor === 'Nothing') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{availableUsers: availableUsers, selectedUser: 0, quantity: 0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{availableUsers: availableUsers, selectedUser: _p9._0.identifier}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'SetNewUserBalance':
				var _p10 = _p1._0;
				if (_p10.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
			...
			case 'SelectUserForDeposit':
				var _p11 = _elm_lang$core$String$toInt(_p1._0);
				if (_p11.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{selectedUserForDeposit: _p11._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'SetDepositQuantity':
				var _p12 = _p1._0;
				if (_p12.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
			...
			case 'RegisterDeposit':
				var user = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (user) {
							return _elm_lang$core$Native_Utils.eq(model.selectedUserForDeposit, user.identifier);
						},
						model.users));
				var _p13 = user;
				if (_p13.ctor === 'Nothing') {
					...
					return {
						...
						_0: model,
						_1: A3(
							_user$project$Rest_AddDeposit$addDepositCommand,
							A3(_user$project$Models_Transaction$Transaction, _p14.identifier, _p14.name, model.depositQuantity),
							model.addDepositUrl,
							model.csrf_token)
					};
				}
			case 'RegisterTransactions':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(_user$project$Rest_RegisterTransactions$registerTransactionsCommand, model.transactions, model.addTransactionsUrl, model.csrf_token)
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$initialModel = function (flags) {
	return {
		...
		_0: _user$project$Model$Model(
			{ctor: '[]'})('')(0)(0)(
			{ctor: '[]'})(
			{ctor: '[]'})(_user$project$Models_Page$Cart)('')('')(0)(0)(0)(false)('')('')(flags.successPageUrl)(flags.getUsersUrl)(flags.createNewUserUrl)(flags.addDepositUrl)(flags.addTransactionsUrl)(flags.csrf_token),
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _user$project$Main$msgToCmd(_user$project$Msg$LoadUsers),
				_1: {ctor: '[]'}
			})
	};
};
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (addDepositUrl) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				function (addTransactionsUrl) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						function (createNewUserUrl) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								function (csrf_token) {
									return A2(
										...
										function (getUsersUrl) {
											return A2(
												_elm_lang$core$Json_Decode$andThen,
												function (successPageUrl) {
													return _elm_lang$core$Json_Decode$succeed(
														{addDepositUrl: addDepositUrl, addTransactionsUrl: addTransactionsUrl, createNewUserUrl: createNewUserUrl, csrf_token: csrf_token, getUsersUrl: getUsersUrl, successPageUrl: successPageUrl});
												},
												A2(_elm_lang$core$Json_Decode$field, 'successPageUrl', _elm_lang$core$Json_Decode$string));
										},
										A2(_elm_lang$core$Json_Decode$field, 'getUsersUrl', _elm_lang$core$Json_Decode$string));
								},
								A2(_elm_lang$core$Json_Decode$field, 'csrf_token', _elm_lang$core$Json_Decode$string));
						},
						A2(_elm_lang$core$Json_Decode$field, 'createNewUserUrl', _elm_lang$core$Json_Decode$string));
				},
				A2(_elm_lang$core$Json_Decode$field, 'addTransactionsUrl', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'addDepositUrl', _elm_lang$core$Json_Decode$string)));
